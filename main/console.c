...
#define HISTORY_PATH CONFIG_SPIFFS_MOUNT_POINT "/history.txt"
...
static void initialize_console(void)
{
    ...
    esp_vfs_dev_uart_port_set_rx_line_endings(USB_UART_NUM, ESP_LINE_ENDINGS_CR);
    /* Move the caret to the beginning of the next line on '\n' */
    esp_vfs_dev_uart_port_set_tx_line_endings(USB_UART_NUM, ESP_LINE_ENDINGS_CRLF);
    ...
    ESP_ERROR_CHECK( uart_driver_install(USB_UART_NUM,
            256, 0, 0, NULL, 0) );
    ESP_ERROR_CHECK( uart_param_config(USB_UART_NUM, &uart_config) );

    /* Tell VFS to use UART driver */
    esp_vfs_dev_uart_use_driver(USB_UART_NUM);
...
#else
    ESP_LOGI(MODULE_CONSOLE, "Command history disabled");
#endif
